...
export interface PedidoLinea {
  ...
  /** ¿Una orden de compra VIVA referencia esta línea? Es la verdad (la FK de
   ...
   *  reemplazar ni devolver. Una orden ELIMINADA no cuenta: sus líneas siguen en la
   *  tabla, pero la orden ya no existe. Lo resuelve el repo al leer. */
  enOrden?: boolean;
  notas?: string;
