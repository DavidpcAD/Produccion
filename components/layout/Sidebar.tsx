...
const navItems: NavItemDef[] = [
  ...
  { href: '/compras/ingenieria', label: 'Pedidos',       icon: 'boleta', minLevel: 2 },
  { href: '/compras/aprobacion', label: 'Aprobación OC', icon: 'rol',    minLevel: 2 },
  { href: '/compras/proveeduria',label: 'Proveeduría',   icon: 'list',   minLevel: 2 },
  { href: '/compras/facturacion',label: 'Facturación',   icon: 'boleta', minLevel: 2 },
  { href: '/utilidades',label: 'Utilidades',    icon: 'calculator', minLevel: 2 },
  { href: '/marcaje',   label: 'Marcaje',       icon: 'reloj',     minLevel: 2 },
