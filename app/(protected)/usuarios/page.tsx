  ...
  return (
    <div className="p-6 max-w-xl mx-auto animate-fade-in">
      <div className="bg-ds-surface rounded-ds-lg border border-ds-gray-200 shadow-ds-01 p-8 text-center">
        ...
        <h1 className="text-heading font-bold text-ds-ink">Los colaboradores se administran en RRHH</h1>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href="/cuadrillas">
            <span className="inline-flex items-center gap-2 rounded-ds-lg bg-ds-surface text-ds-ink font-semibold px-6 py-3 border border-ds-gray-200 hover:bg-ds-gray-100 transition-colors">
              Ir a Cuadrillas
            </span>
          </Link>
        </div>
