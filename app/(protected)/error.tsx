...
export default function ProtectedError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto animate-fade-in">
      <div className="bg-white rounded-ds-lg border border-ds-gray-200 shadow-ds-01 p-12 text-center">
        ...
        <h1 className="text-sub-sm font-bold text-black">Algo salió mal</h1>
