    ...
    <PageShell>
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} className="bg-white rounded-ds-lg border border-ds-gray-200 p-5 space-y-3">
        ...
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4"
          ...
          {proyectos.map(p => (
            <motion.button
              ...
              className="group bg-white rounded-ds-lg border border-ds-gray-200 shadow-ds-01 p-5 text-left hover:border-black hover:shadow-ds-03 transition-all duration-200 hover:-translate-y-0.5"
            >
              ...
              <h3 className="font-bold text-black mb-1 line-clamp-2 text-sm">{p.Nombre}</h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <Icon name="arrow-right" size="sm" color="currentColor" className="text-ds-gray-300 group-hover:text-black transition-colors" />
              </div>
            </motion.button>
          ))}
        </motion.div>
